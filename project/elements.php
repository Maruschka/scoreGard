...
function get_spins() 
{
	$elements = array(
		...
		$_AspB = new Element('AspB', 'Camel', 'Spin', 0.2), 
		$_Asp1 = new Element('Asp1', 'Camel', 'Spin', 1.2), 
		$_Asp2 = new Element('Asp2', 'Camel', 'Spin', 2.2), 
		$_Asp3 = new Element('Asp3', 'Camel', 'Spin', 3.2), 
		$_Asp4 = new Element('Asp4', 'Camel', 'Spin', 4.2), 
